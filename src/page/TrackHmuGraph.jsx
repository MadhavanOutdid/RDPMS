...
function TrackHmuGraph() {
  return (
    <div className="content-wrapper" style={{ minHeight: '817px' }} id="graphData">
        <section className="content-header">
            <div className="container-fluid">
                <div className="row mb-2">
                    <div className="col-sm-6 module-name-graph"></div>
                    <div className="col-sm-6" id="back-page">                                    
                        <ol className="breadcrumb float-sm-right">
                            <Link to="/trackhmuhistory"><button type="button" className="btn btn-info">Back</button></Link>
                        </ol>
                    </div>
                </div>
            </div>
